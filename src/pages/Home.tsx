...
const Home = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-primary-700 via-primary-800 to-primary-900 text-white">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/about" className="btn-outline bg-white/10 border-white text-white hover:bg-white hover:text-primary-600">
                Learn More
              </Link>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-5 gap-6 mt-12">
            {[
              ...
              <motion.div
                ...
                className="card p-6"
              >
                <service.icon className="text-5xl text-primary-600 mx-auto mb-4" />
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="card p-8 text-center"
            >
              <FaPray className="text-5xl text-primary-600 mx-auto mb-4" />
            ...
            <motion.div
              ...
              className="card p-8 text-center"
            >
              <FaHeart className="text-5xl text-gold-500 mx-auto mb-4" />
