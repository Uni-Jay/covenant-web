      ...
      <section className="py-12">
        <div className="container-custom max-w-4xl">
          ...
          >
            ...
            <div className="bg-primary-50/90 border-2 border-primary-200 rounded-2xl p-8 mb-8">
            ...
            <div className="bg-primary-50/90 border border-primary-200 rounded-2xl p-6 text-center">
          ...
          <motion.div
            ...
            className="card p-8 mt-8 bg-gradient-to-r from-primary-700 to-secondary-700 text-white text-center border border-primary-200/40"
          >
